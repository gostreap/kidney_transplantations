...
Let's run the Cycles and Chains Matching Algorithm with rule A on this example. The initial state of the graph, before the first round, is shown in figure 1.
